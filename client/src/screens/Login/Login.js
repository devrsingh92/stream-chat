        ...
        return (
            <Root>
                ...
                <Header>
                    ...
                    {isLoggedIn && <LogoutBtn label='Logout' onClick={this.handleLogout} />}
                </Header>
                {/* {isAuthed ? this.renderWelcome() : this.renderForm()} */}
                {isLoggedIn ? this.renderWelcome() : this.renderForm()}
            </Root>
        );
    }
}
...
export default connect(mapStateToProps, { loginRequest, queueSnackbar })(Login);
